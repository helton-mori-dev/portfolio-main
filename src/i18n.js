  ...
  resources: {
    ...
    pt: {
      translation: {
        ...
        workOng:
          "O projeto teve como objetivo facilitar doações e facilitar a comunicação entre o público e a ONG. Colaborei com uma designer que liderou a parte de UX/UI, e fui responsável pela implementação do front-end usando <strong>Vue.js, Vuetify, Vue Router e CSS.</strong>",
        goTo: "Ir para",
